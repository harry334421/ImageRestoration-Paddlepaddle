...
parser.add_argument(
    ...
    "--img_path",
    type=str,
    default="6364_MechineLearning/Final/imgs/01.jpg",
)
...
imageio.imsave("6364_MechineLearning/Final/dst/_eccv16.png", out_img_eccv16)
imageio.imsave(
    "6364_MechineLearning/Final/dst/_siggraph17.png",
    out_img_siggraph17,
)
